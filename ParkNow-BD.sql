...
-- Copiando dados para a tabela parknow.automovel: ~0 rows (aproximadamente)
...
INSERT INTO `cadastro` (`id`, `nome`, `sobrenome`, `cpf`, `endereco`, `cep`, `telefone`, `email`, `senha`) VALUES
	(1, 'BBBBB', 'AAAA', '462.709.348-93', 'rua teste bom', 19160000, '18998165080', 'teste@gamil.com', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4');
...
INSERT INTO `local` (`id_lugar`, `nome`, `cidade`, `endereco`, `cep`, `vagas`, `func_horario`, `latitude`, `longitude`) VALUES
	(1, 'PrudenShopping', 'Pres. Prudente', 'Rua teste Alfa', 19060000, 300, '10h - 22h', NULL, NULL),
	(2, 'Local A', 'pp', 'rota do sol', 19063755, 300, '10h-22h', -23.550520, -46.633308);
